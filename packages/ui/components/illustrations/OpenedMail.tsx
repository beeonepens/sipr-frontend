...
export function OpenedMail({ className = 'h-5 w-5', theme = 'light' }: Props) {
  if (theme === 'dark') return <OpenedMailLight className={className} />;
  else return <OpenedMailDark className={className} />;
}

function OpenedMailLight({ className }: { className: string }) {
  return (
    <svg
      id="SvgjsSvg1020"
      className={className}
      ...
      <g id="SvgjsG1022">
        ...
        >
          <path
            ...
            className="color165ea2 svgShape"
          ></path>
          <path
            fill="#3f3d56"
            ...
            transform="translate(-319.5 -203.5)"
            className="color3f3d56 svgShape"
          ></path>
          <path
            fill="#ffffff"
          ...
          <path
            ...
            transform="translate(-319.5 -203.5)"
            className="colore6e6e6 svgShape"
          ></path>
          <path
            fill="#165ea2"
          ...
          <path
            fill="#e6e6e6"
            d="M703 399.5H497a8 8 0 010-16H703a8 8 0 010 16zM703 429.5H497a8 8 0 010-16H703a8 8 0 010 16z"
            transform="translate(-319.5 -203.5)"
            className="colore6e6e6 svgShape"
          ></path>
        </svg>
...
function OpenedMailDark({ className }: { className: string }) {
  return (
    <svg
      id="SvgjsSvg1020"
      className={className}
