...
export default function UpcomingSchedule({ events }: Props) {
  return (
    <div className="grid grid-cols-1 justify-center gap-4 rounded-lg border border-gray-300 bg-white p-4 shadow-md shadow-gray-300/25 dark:border-gray-600 dark:bg-zinc-800 dark:shadow-black/20">
