...
export default function Sidebar() {
  ...
  return (
    <aside
      className={clsx(
        'text-primary-700 fixed top-0 z-10 max-h-screen min-h-screen flex-col justify-between overflow-hidden border-r border-gray-300 bg-gray-100 py-8 px-4 duration-300 dark:border-gray-700 dark:bg-zinc-800 dark:text-gray-100 lg:sticky',
        isMini
