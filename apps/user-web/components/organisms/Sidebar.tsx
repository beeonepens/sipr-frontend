  ...
  return (
    <aside
      className={clsx(
        ...
        'text-primary-700 absolute top-0 z-10 max-h-screen min-h-screen flex-col justify-between overflow-hidden border-r border-gray-300 bg-gray-100 py-8 px-4 duration-300 md:sticky',
        isMini
