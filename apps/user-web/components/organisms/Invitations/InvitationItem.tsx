...
export default function InvitationItem() {
  return (
    <div className="flex flex-col items-start gap-3 rounded-lg px-4 py-3 outline outline-1 outline-gray-300 dark:outline-gray-700 md:flex-row md:items-center md:gap-5 lg:px-6">
      <InvitationAvatar />
