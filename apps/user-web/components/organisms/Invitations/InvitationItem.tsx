...
export default function InvitationItem() {
  return (
    <div className="flex flex-col items-start gap-3 rounded-lg bg-white px-4 py-3 shadow-md shadow-gray-300/25 outline outline-1 outline-gray-300 dark:bg-gray-800 dark:shadow-black/20 dark:outline-gray-600 md:flex-row md:items-center md:gap-5 lg:px-6">
      <InvitationAvatar />
