...
export default function ZeroAgenda() {
  ...
  return (
    <div className="relative mt-4 flex flex-col items-center justify-center gap-2 overflow-x-auto rounded-md border border-gray-300 bg-white p-8 text-center shadow-md shadow-gray-300/25 dark:border-zinc-700 dark:bg-zinc-800 dark:shadow-black/20 sm:rounded-lg lg:p-12">
      <NoData
