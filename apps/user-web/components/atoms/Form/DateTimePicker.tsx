        ...
        <div className="relative">
          <ReactDatePicker
            ...
            className={clsx(
              ...
              readOnly
                ? 'cursor-not-allowed border-gray-300 bg-gray-100 focus:border-gray-300 focus:ring-0 dark:border-gray-800 dark:bg-gray-700'
                : errors && errors[id]
              ...
              'block w-full rounded-lg bg-white dark:bg-gray-800 dark:text-gray-300 dark:caret-gray-500 sm:text-sm'
            )}
