      ...
      <PopoverPrimitive.Root>
        ...
        <PopoverPrimitive.Content
          ...
          className={clsx(
            ...
            'max-h-[60vh] w-80 overflow-y-auto rounded-l-lg rounded-tr-md rounded-br-lg border border-gray-300 px-4 pb-4 shadow-md shadow-gray-300/30 dark:border-gray-700 dark:shadow-gray-700/30 md:w-96',
