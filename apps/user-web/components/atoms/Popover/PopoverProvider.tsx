      ...
      <PopoverPrimitive.Root>
        ...
        <PopoverPrimitive.Content
          ...
          className={clsx(
            ...
            'max-h-[60vh] w-80 overflow-y-auto rounded-l-lg rounded-tr-md rounded-br-lg border border-gray-300 px-4 pb-4 shadow-md shadow-gray-300/30 md:w-96',
        ...
        >
          ...
          <div className="tems-center sticky top-0 flex flex-row justify-between border-b border-gray-200 bg-gray-50 pb-2 pt-4 dark:bg-gray-800">
