    ...
    <>
      ...
      >
        <div className="mt-4 mb-4 grid grid-cols-2 gap-6 lg:mb-2 lg:grid-cols-4 xl:grid-cols-6">
          {/* add item button */}
          <figure className="relative flex h-full w-full flex-col items-center justify-center rounded-lg outline-dashed  outline-1 outline-gray-300 hover:cursor-pointer dark:outline-gray-700">
