    ...
    <>
      ...
      >
        ...
        >
          ...
          <figure
            className={clsx(
              'relative flex flex-col items-center justify-center rounded-lg bg-white shadow-md shadow-gray-300/25 outline-dashed outline-1 outline-gray-300 hover:cursor-pointer dark:bg-zinc-900 dark:shadow-black/20 dark:outline-gray-700',
